<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="DDAC_MaerskLineRegion2._Default" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
   <div class="jumbotron">
        <h1>Maersk Line - Transport and Logistics [US WEST 2]</h1> <br />
        <p class="lead">Welcome to Cloud Services Platform for Maersk Line on US West 2 Server.</p>
