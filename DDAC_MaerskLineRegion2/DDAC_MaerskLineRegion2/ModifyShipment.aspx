<%@ Page Title="Maersk Line - Modify Shipment" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ModifyShipment.aspx.cs" Inherits="DDAC_MaerskLineRegion2.ModifyShipment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container" style="background-color:aliceblue; padding:10px">
        ...
        <asp:GridView ID="GridView1" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" AutoGenerateColumns="False" DataKeyNames="Id" DataSourceID="SqlDataSource_ModifyShipment" Width="1000px">
